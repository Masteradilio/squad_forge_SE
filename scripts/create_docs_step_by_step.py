...
content = """# Guia Completo: Portfólio Bilíngue Autônomo & Assistente de Carreira com RAG
...
p = pathlib.Path("docs/passo_a_passo_publicar_portfolio.md")
p.parent.mkdir(parents=True, exist_ok=True)
p.write_text(content, encoding="utf-8")
print("docs/passo_a_passo_publicar_portfolio.md created successfully.")
