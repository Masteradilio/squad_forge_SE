...
def apply_api_led_task_contracts(db_path: str) -> dict[str, int]:
    ...
    The PRD extractor intentionally keeps bullet-level tasks. This benchmark layer
    adds the explicit V3 contract expected by MASTER_BACKLOG_V3: complex product,
