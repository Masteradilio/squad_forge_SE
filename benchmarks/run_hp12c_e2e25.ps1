...
$workspace = Join-Path $root "benchmarks\workspaces\hp12c-v6-omniroute-e2e-25"
...
Start-Process -FilePath $python -ArgumentList "-m localforge.cli.main run --unattended" -WorkingDirectory $workspace -RedirectStandardOutput $out -RedirectStandardError $err -WindowStyle Hidden -PassThru | Select-Object Id,StartTime
