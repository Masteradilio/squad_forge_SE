...
def get_js() -> str:
    ...
    const translations = {
      pt: {
        ...
        bot_welcome: "Olá! Sou o assistente virtual de <strong>Adilio Farias</strong>. Estou conectado aos currículos completos e aos READMEs técnicos dos 7 repositórios públicos. Pergunte o que quiser sobre minhas experiências, educação e projetos!",
      ...
      en: {
        ...
        bot_welcome: "Hello! I am the virtual assistant for <strong>Adilio Farias</strong>. I have permanent access to Adilio's full resume and the technical READMEs of all 7 public repositories. Feel free to ask anything about my experience, education, and projects!",
        bot_send_btn: "Ask",
